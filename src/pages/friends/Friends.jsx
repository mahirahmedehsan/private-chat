...
function FriendCard({ friend, onlineUsers, activeTab, onRespond, onRemove, onBlock, onUnblock }) {
  ...
  return (
    ...
    >
      <div className="group relative flex items-center gap-3 px-4 py-3.5 bg-dark-100 border border-dark-400 rounded-xl hover:border-accent/30 hover:bg-dark-150 transition-all duration-200 mb-1.5">
        ...
        {activeTab !== 'blocked' && !friend.direction && (
          <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            ...
            <div className="relative" ref={blockRef}>
              ...
              {blockOpen && (
                <div className="absolute right-0 top-full mt-1.5 w-44 bg-dark-200 border border-dark-450 rounded-xl shadow-xl py-1.5 z-50">
...
function EmptyState({ activeTab, onAddFriend }) {
  ...
  return (
    ...
    >
      <div className="w-16 h-16 rounded-2xl bg-dark-200 border border-dark-400 flex items-center justify-center mb-5">
...
function SearchResult({ user, onSendRequest }) {
  return (
    <motion.button
      ...
      className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-dark-150 transition-colors group"
    >
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-gutter">
        <div className="max-w-2xl mx-auto p-4 md:p-6">
          ...
          <div className="flex gap-1 mb-5 p-1 bg-dark-200 border border-dark-400 rounded-xl">
            {tabs.map((tab) => {
          ...
          {isLoading ? (
            <div className="space-y-2">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex items-center gap-3 p-4 bg-dark-100 border border-dark-400 rounded-xl">
        ...
        <div className="space-y-3">
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="w-full bg-dark-200 border border-dark-400 rounded-xl pl-10 pr-4 py-2.5 text-sm text-text-primary placeholder-text-muted/60 focus:outline-none focus:ring-2 focus:ring-accent/25 focus:border-accent/40 transition-all"
            />
          </div>
